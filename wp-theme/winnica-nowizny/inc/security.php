...
add_action('send_headers', function (): void {
    ...
    // HSTS and the report-only CSP are configured in the production web
    // server. Keeping them outside PHP also covers cached/error responses and
    // prevents two sources from drifting apart.
});
